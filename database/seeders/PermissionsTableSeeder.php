...
class PermissionsTableSeeder extends Seeder
{
    ...
    private function permissions()
    {
        return [
            ...
            'Top New Member Producer', 'Top Gainer', 'Last Member Transaction', 'Symbol Statistic', 'Closed Order By LQ Time', 'Affiliate Commission', 'Tree View', 'Referral Bonus', 'Net Margin Bonus', 'Allowance'
        ];
    }
