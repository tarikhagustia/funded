...
@section('content')
    <div class="container-fluid">
        <div class="fade-in">
            ...
            <livewire:console.dashboard.af-statistic></livewire:console.dashboard.af-statistic>
        </div>
    </div>
@endsection
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function cb2(start, end) {
                ...
                $('#reportrange-client span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
                window.Livewire.emit('filterDateChanged2', {
                    date_start: start.format('YYYY-MM-D'),
                    date_end: end.format('YYYY-MM-D')
                })
            }
            ...
            $('#reportrange-client').daterangepicker({
                startDate: start,
                endDate: end,
                ranges: {
                    'Today': [moment(), moment()],
