                    ...
                    <div class="row">
                        @can('Top Looser')
                            <div class="col-sm-4 mb-4">
                                ...
                                <a href="{{ route('console.reports.statistics.top-looser') }}"
                                   class="btn btn-outline-info">{{ __('See Report') }}</a>
                            </div>
                        @endif

                        @can('Top Commission and OR Producer')
                            <div class="col-sm-4 mb-4">
                                <h3>{{ __('Top Commission and OR Producer') }}</h3>
                                <p>{{ __('Displaying affiliate who generate commission higer ') }}</p>
                                <a href="{{ route('console.reports.statistics.top-commission') }}"
                                   class="btn btn-outline-info">{{ __('See Report') }}</a>
                            </div>
                        @endif

                        @can('Top New Member Producer')
                            <div class="col-sm-4  mb-4">
                                <h3>{{ __('Top New Member Producer') }}</h3>
                                <p>{{ __('Displaying Affiliate who get member higher.') }}.</p>
                                <a href="{{ route('console.reports.statistics.top-new-member') }}"
                                   class="btn btn-outline-info">{{ __('See Report') }}</a>
                            </div>
                        @endcan
                        ...
                        @can('Last Member Transaction')
                            <div class="col-sm-4 mb-4">
                                ...
                                <a href="{{ route('console.withdrawals.index') }}"
                                   class="btn btn-outline-info">{{ __('See Report') }}</a>
                            </div>
                        @endcan
                        ...
                        @can('Tree View')
                            <div class="col-sm-4 mb-4">
                                ...
                                <a href="{{ route('console.reports.statistics.treeview') }}"
                                   class="btn btn-outline-info">{{ __('See Report') }}</a>
                            </div>
                        @endcan
                    </div>
