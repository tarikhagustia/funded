...
class CommissionCalculationService
{
    public function calculateCommissionFor(Carbon $date)
    {
        $queryAccounts = DB::connection('crm')->table('accounts', 'a')
                           ->select(['a.accountid', 'agr.account_type', 'agr.max_rebate', 'c.nama', 'r.rate', 'ag.id as agent_id', 'ag.agentcode', 'ag.agentname', 'ac.commission as comm_charge', 'ac.ov as or', DB::raw('IFNULL(a.bop, 0) as bop')])
